...
class GStrings {
  ...
  static const String captureReviewMsg = 'Review day — clear what no longer matters.';
  ...
  static const String addPersonPhoneHint1 = 'International format — e.g. +263712345678';
  ...
  static const Map<String, String> messageTemplates = {
    'Motivator':
      'Hey {name} 👋 You\'ve been selected as today\'s Motivator. '
      'Share something that keeps you going — a word, a thought, anything real. '
      'We need it today. 🔥',

    'Meditator':
      'Hey {name} 🌿 You\'re today\'s Meditator. '
  ...
  static const String authEmptyFieldsErr  = 'Please enter both email and password.';
